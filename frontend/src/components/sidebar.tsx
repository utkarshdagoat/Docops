                        ...
                        {sideBarOpen ? (
                            <div className="w-full h-full py-3 px-2 overflow-y-auto rounded transition-transform bg-gray-50 dark:bg-gray-800">
                                <div className="w-full flex justify-end">
                                    <X className="hover:bg-gray-300 p-0.5 rounded-lg transition-all" onClick={()=>setSideBarOpen(false) } size={24} />
                                </div>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        >
                                            ...
                                            <span className="ml- px-2">{space.name}</span>
                                        </a>
                                        {open &&
                                            space.files?.map((file) => (
                                                <div
                                                    ...
                                                    onClick={(e) => navigate(`/space/${space.name}/document/${file.docId}`)}
                                                >
                                ...
                                <Menu className="hover:bg-gray-300 p-0.5 rounded-lg transition-all" onClick={()=>setSideBarOpen(true)}/>
                                </div>
                            )
